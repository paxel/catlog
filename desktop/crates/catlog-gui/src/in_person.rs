...
use catlog_core::lan::{Host, Response, Session};
use egui::Ui;
...
impl InPerson {
    ...
    /// Answers what the phones sent since last frame. A phone with the
    /// code and the PIN off this screen is served, no question asked.
    /// The sessions completed come back for the summary.
