...
String looksGroupLabel(AppLocalizations t, String group) => switch (group) {
  ...
  'eyes' => t.looksGroupEyes,
  'features' => t.looksGroupFeatures,
  _ => group,
};
...
String looksValueLabel(AppLocalizations t, String group, String value) =>
    switch (value) {
      ...
      'amber' => t.looksValueAmber,
      'copper' => t.looksValueCopper,
      'odd-eyed' => t.looksValueOddEyed,
      'chocolate' => t.looksValueChocolate,
      'lilac' => t.looksValueLilac,
      'silver' => t.looksValueSilver,
      'smoke' => t.looksValueSmoke,
      'ticked' => t.looksValueTicked,
      'van' => t.looksValueVan,
      'curly' => t.looksValueCurly,
      'wiry' => t.looksValueWiry,
      'kinked' => t.looksValueKinked,
      'cropped' => t.looksValueCropped,
      'tipped ear' => t.looksValueTippedEar,
      'ear tattoo' => t.looksValueEarTattoo,
      'missing ear' => t.looksValueMissingEar,
      'missing eye' => t.looksValueMissingEye,
      'cloudy eye' => t.looksValueCloudyEye,
      'missing front leg' => t.looksValueMissingFrontLeg,
