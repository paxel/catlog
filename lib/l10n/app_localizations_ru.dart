...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get agendaEmpty =>
      'Ничего не запланировано. Выберите у поля будущую дату, и она появится здесь.';
  ...
  String get calendarMirrorSubtitle =>
      'Каждый срок становится событием на весь день в календаре cat(a)log на этом устройстве. Даты меняйте в cat(a)log, а не в календаре.';
  ...
  String get spotHomeAgenda =>
      'Напоминания: всё, что предстоит, по всем кошкам и клаудерам.';

  @override
  String get spotAddReminder =>
      'Добавить напоминание — план с датой. Он показывается в напоминаниях, а не на странице, пока вы не отметите его выполненным.';

  @override
  String get spotAgendaAdd => 'Новый план: выберите поле, дату и значение.';

  @override
  String get spotAgendaCalendar =>
      'Включите это, чтобы видеть каждый срок в календаре телефона.';

  @override
  String get helpAgenda =>
      'Всё, что предстоит, по датам; просроченное остаётся наверху, пока не будет улажено. Нажмите на карточку, чтобы открыть кошку или клаудер. Галочка отмечает план выполненным — она записывает значение и может запланировать следующий раз. Удерживайте карточку, чтобы изменить дату или убрать план. Переключатель календаря отражает каждый срок в календарь телефона; меню экспортирует их файлом календаря.';
