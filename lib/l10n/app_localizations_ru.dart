...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String get deleteCatBody =>
      'Кошка исчезает из всех списков, её фото удаляются — здесь, а после следующей синхронизации и у ваших помощников.';
  ...
  String get spotHomeSync =>
      'Новое: синхронизация теперь предлагает три понятных пути — и вопрос доверия, прежде чем что-то уйдёт.';

  @override
  String get spotHomeStrays =>
      'Новое: у бездомных теперь своя карточка здесь сверху — количество, мордочки, нажмите, чтобы открыть.';

  @override
  String get spotHomeMenu =>
      'Новое: это меню находит дубликаты кошек и колоний и объединяет их.';

  @override
  String get spotCatEdit =>
      'Новое: страница только для чтения — карандаш включает редактирование, долгое нажатие на поле редактирует его сразу.';

  @override
  String get spotMapLayers =>
      'Новое: показать круги поиска 500 м вокруг мест объявлений пропавшей кошки.';

  @override
  String get spotStraysFlier =>
      'Новое: сфотографируйте объявление о пропавшей кошке — оно станет кошкой, хозяином и контактом.';

  @override
  String get spotStraysScan =>
      'Новое: отсканируйте код cat(a)log с объявления, чтобы импортировать кошку напрямую.';

  @override
  String get introTitle4 => 'Пропавшие кошки';

  @override
  String get introBody4 =>
      'Сфотографируйте объявление — пропавшая кошка попадёт в каталог с контактом хозяина. Наблюдения, круги поиска и предложения совпадений помогают вернуть её домой.';

  @override
  String get spotMapSearch =>
      'Новое: ищите здесь кошек, клаудеры и людей — прямо на карте.';

  @override
  String get spotCardChips =>
      'Новое: выберите, что попадёт на карточку, прежде чем делиться ею.';

  @override
  String get spotCatMenu =>
      'Новое: пометьте кошку как личную (никогда не покидает устройство) или скройте её здесь.';
