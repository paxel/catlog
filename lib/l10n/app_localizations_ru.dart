...
class AppLocalizationsRu extends AppLocalizations {
  ...
  String deleteCatalogBody(String name) {
    return 'Всё в каталоге $name исчезнет: кошки, фотографии, история. Сначала полный файл сохраняется туда же, куда идут автоматические резервные копии, — его импорт вернёт каталог. Введите показанное слово для подтверждения.';
  }
