...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String get helpClowderNeutral =>
      'הכול על המקום הזה: חיות המחמד, השדות (כתובת, איש קשר, סוג) וההיסטוריה. הדף נפתח לקריאה בלבד; העיפרון מפעיל עריכה, ושם אפשר גם להוסיף שדה. לחיצה ארוכה על שדה עורכת אותו מיד, על חיית מחמד מעבירה, מסתירה או פותחת אותה. תור שנוסף כאן יכול לקחת כמה חיות מחמד ממשק הבית, למשל לעיקור: סמנו את חיות המחמד שבאות, סיימו פעם אחת, בטלו את הסימון של אלה שלא טופלו.';
  ...
  String get helpCatNeutral =>
      'הכול על חיית המחמד הזו: תמונות, שדות, משפחה, היסטוריה. הדף לקריאה בלבד עד שנוגעים בעיפרון. לחיצה ארוכה על שדה עוברת ישר לעריכתו; לחיצה ארוכה על תמונה פותחת את התפריט שלה. התפריט למעלה מחזיק את השאר: הסתרה, מיזוג, רישום תצפית, שיתוף חיית המחמד. פרטי נקבע בעת עריכת שדה.';
