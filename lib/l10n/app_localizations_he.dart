...
class AppLocalizationsHe extends AppLocalizations {
  ...
  String get helpCatalogsNeutral =>
      'כל קטלוג הוא עולם בפני עצמו: חיות המחמד, משקי הבית, השדות, התמונות ושותפי הסנכרון שלו. ברלין ופריז לעולם לא מתערבבות. הקש על השם בראש המסך הראשי כדי להחליף, להוסיף או לשנות שם. השם שלך, השפה והטיפים שכבר ראית משותפים לכולם.';
