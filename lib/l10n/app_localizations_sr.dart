...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get reminderDialogHint =>
      'Приказује се у подсетницима док га не означиш обављеним. Тренутна вредност остаје каква јесте.';
  ...
  String get noWritableCalendar =>
      'Ни у један календар на овом уређају не може да се пише. Додај налог календара у подешавањима система и покушај поново.';

  @override
  String get spotHomeAgenda =>
      'Подсетници: све што доспева, за све мачке и клаудере.';

  @override
  String get spotAddReminder =>
      'Додај подсетник — план са датумом. Приказује се у подсетницима, не на страници, док га не означиш обављеним.';

  @override
  String get spotAgendaAdd => 'Нови план: одабери поље, датум и вредност.';

  @override
  String get spotAgendaCalendar =>
      'Укључи ово да видиш сваки рок у календару свог телефона.';

  @override
  String get helpAgenda =>
      'Све што доспева, по датуму; закаснело остаје на врху док се не реши. Додирни картицу да отвориш мачку или клаудер. Квачица означава план обављеним — бележи вредност и може да закаже следећи круг. Држи картицу притиснуту да промениш датум или је уклониш. Прекидач календара пресликава сваки рок у календар твог телефона; мени их извози као календарску датотеку.';
