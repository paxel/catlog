...
class AppLocalizationsSr extends AppLocalizations {
  ...
  String get shareWhitelistExplainer =>
      'Каталог напуштају само штиклирана поља. Све остало остаје код куће.';
  ...
  String get spotHomeStrays =>
      'Ново: луталице имају своју картицу овде горе — број, њушкице, додирните за отварање.';

  @override
  String get spotHomeMenu =>
      'Ново: овај мени налази дупликате мачака и колонија и спаја их.';

  @override
  String get spotCatEdit =>
      'Ново: страница је само за читање — оловка пребацује на уређивање, дуги притисак на поље уређује га директно.';

  @override
  String get spotMapLayers =>
      'Ново: прикажите кругове претраге од 500 м око места огласа нестале мачке.';

  @override
  String get spotStraysFlier =>
      'Ново: сликајте оглас нестале мачке — постаје мачка, власник и контакт.';

  @override
  String get spotStraysScan =>
      'Ново: скенирајте cat(a)log код са огласа да директно увезете мачку.';

  @override
  String get introTitle4 => 'Нестале мачке';

  @override
  String get introBody4 =>
      'Сликајте оглас и нестала мачка улази у каталог са контактом власника. Виђења, кругови претраге и предлози парова помажу јој да се врати кући.';
