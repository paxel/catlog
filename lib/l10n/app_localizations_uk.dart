...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get spotHomeAgenda =>
      'Нагадування: усе, що на черзі, по всіх котах і клаудерах.';

  @override
  String get spotAddReminder =>
      'Додати нагадування — план із датою. Він показується в нагадуваннях, а не на сторінці, доки ви не позначите його виконаним.';

  @override
  String get spotAgendaAdd => 'Новий план: виберіть поле, дату й значення.';

  @override
  String get spotAgendaCalendar =>
      'Увімкніть це, щоб бачити кожен термін у календарі телефона.';

  @override
  String get helpAgenda =>
      'Усе, що на черзі, за датою; прострочене лишається вгорі, доки не буде залагоджене. Торкніться картки, щоб відкрити кота чи клаудер. Галочка позначає план виконаним — вона записує значення й може запланувати наступний раз. Утримуйте картку, щоб змінити дату або прибрати план. Перемикач календаря віддзеркалює кожен термін у календар телефона; меню експортує їх файлом календаря.';
