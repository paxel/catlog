...
class AppLocalizationsAr extends AppLocalizations {
  ...
  String deleteCatalogBody(String name) {
    return 'كل ما في $name سيختفي: القطط والصور والسجل. تُحفظ أولاً نسخة كاملة حيث تُحفظ النسخ الاحتياطية التلقائية، واستيرادها يعيد الكتالوج. اكتب الكلمة المعروضة للتأكيد.';
  }
