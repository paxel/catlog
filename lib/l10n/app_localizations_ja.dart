...
class AppLocalizationsJa extends AppLocalizations {
  ...
  String get helpClowderNeutral =>
      'この場所のすべて：ペット、項目（住所・連絡先・種別）、履歴。最初は閲覧のみで、鉛筆で編集に切り替わり、そこで項目の追加もできます。項目を長押しすると直接編集、ペットを長押しすると移動・非表示・表示ができます。 ここで追加する予定には世帯の複数のペットを含められます（例：去勢・避妊の通院）。一緒に行くペットにチェックを入れ、一度で完了し、処置されなかったペットのチェックを外します。';
  ...
  String get helpCatNeutral =>
      'このペットのすべて: 写真、フィールド、家族、履歴。鉛筆をタップするまでページは読み取り専用です。フィールドを長押しするとすぐ編集できます。写真を長押しするとそのメニューが開きます。右上のメニューに残りがあります: 非表示、統合、目撃の記録、ペットの共有。「プライベート」はフィールド編集時に設定します。';
  ...
  String get helpCatalogsNeutral =>
      'カタログはそれぞれ独立した世界です。ペットも世帯も項目も写真も同期相手も別々で、ベルリンとパリが混ざることはありません。ホーム画面上部の名前をタップすると、切り替え・追加・名前の変更ができます。あなたの名前、言語、見終わったヒントはすべてのカタログで共通です。';
