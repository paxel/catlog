...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get spotHomeAgenda =>
      'Οι υπενθυμίσεις: ό,τι εκκρεμεί, για όλες τις γάτες και τις ομάδες.';

  @override
  String get spotAddReminder =>
      'Πρόσθεσε υπενθύμιση — ένα πλάνο με ημερομηνία. Εμφανίζεται στις υπενθυμίσεις, όχι στη σελίδα, μέχρι να το σημειώσεις ως έγινε.';

  @override
  String get spotAgendaAdd => 'Νέο πλάνο: διάλεξε πεδίο, ημερομηνία και τιμή.';

  @override
  String get spotAgendaCalendar =>
      'Ενεργοποίησέ το για να βλέπεις κάθε προθεσμία στο ημερολόγιο του τηλεφώνου σου.';

  @override
  String get helpAgenda =>
      'Ό,τι εκκρεμεί, κατά ημερομηνία· ό,τι καθυστερεί μένει πάνω μέχρι να τακτοποιηθεί. Πάτησε μια κάρτα για να ανοίξεις τη γάτα ή την ομάδα. Το τικ σημειώνει ένα πλάνο ως έγινε — καταγράφει την τιμή και μπορεί να προγραμματίσει τον επόμενο γύρο. Κράτησε πατημένη μια κάρτα για να αλλάξεις την ημερομηνία ή να την αφαιρέσεις. Ο διακόπτης ημερολογίου αντικατοπτρίζει κάθε προθεσμία σε ένα ημερολόγιο του τηλεφώνου σου· το μενού τις εξάγει ως αρχείο ημερολογίου.';
