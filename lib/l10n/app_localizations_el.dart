...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get spotHomeStrays =>
      'Νέο: οι αδέσποτες έχουν τη δική τους κάρτα εδώ πάνω — αριθμός, φατσούλες, πατήστε για άνοιγμα.';

  @override
  String get spotHomeMenu =>
      'Νέο: αυτό το μενού βρίσκει διπλότυπες γάτες και αποικίες και τις συγχωνεύει.';

  @override
  String get spotCatEdit =>
      'Νέο: η σελίδα είναι μόνο για ανάγνωση — το μολύβι αλλάζει σε επεξεργασία, το παρατεταμένο πάτημα σε πεδίο το επεξεργάζεται άμεσα.';

  @override
  String get spotMapLayers =>
      'Νέο: εμφανίστε κύκλους αναζήτησης 500 μ. γύρω από τις θέσεις αφισών μιας χαμένης γάτας.';

  @override
  String get spotStraysFlier =>
      'Νέο: φωτογραφίστε μια αφίσα χαμένης γάτας — γίνεται η γάτα, ο ιδιοκτήτης και η επαφή.';

  @override
  String get spotStraysScan =>
      'Νέο: σαρώστε έναν κωδικό cat(a)log από αφίσα για άμεση εισαγωγή της γάτας.';

  @override
  String get introTitle4 => 'Χαμένες γάτες';

  @override
  String get introBody4 =>
      'Φωτογραφίστε μια αφίσα και η χαμένη γάτα μπαίνει στον κατάλογο με την επαφή του ιδιοκτήτη της. Παρατηρήσεις, κύκλοι αναζήτησης και προτάσεις αντιστοίχισης βοηθούν να γυρίσει σπίτι.';
