...
class AppLocalizationsEl extends AppLocalizations {
  ...
  String get helpCatalogsNeutral =>
      'Κάθε κατάλογος είναι δικός του κόσμος: δικά του κατοικίδια, νοικοκυριά, πεδία, φωτογραφίες και συνεργάτες συγχρονισμού. Το Βερολίνο και το Παρίσι δεν ανακατεύονται ποτέ. Πάτησε το όνομα στην κορυφή για αλλαγή, προσθήκη ή μετονομασία. Το όνομά σου, η γλώσσα και οι συμβουλές που είδες είναι κοινές.';
