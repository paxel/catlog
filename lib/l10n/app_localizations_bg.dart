...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get shareWhitelistExplainer =>
      'Само отбелязаните полета напускат каталога. Всичко останало си остава у вас.';
  ...
  String get spotHomeStrays =>
      'Ново: скитниците имат своя карта тук горе — брой, муцунки, докоснете за отваряне.';

  @override
  String get spotHomeMenu =>
      'Ново: това меню намира дублирани котки и колонии и ги слива.';

  @override
  String get spotCatEdit =>
      'Ново: страницата е само за четене — моливът превключва към редактиране, дълго натискане върху поле го редактира направо.';

  @override
  String get spotMapLayers =>
      'Ново: покажете кръгове за търсене от 500 м около местата на обявите на изчезнала котка.';

  @override
  String get spotStraysFlier =>
      'Ново: снимайте обява за изчезнала котка — тя става котката, собственикът и контактът.';

  @override
  String get spotStraysScan =>
      'Ново: сканирайте cat(a)log код от обява, за да импортирате котката директно.';

  @override
  String get introTitle4 => 'Изчезнали котки';

  @override
  String get introBody4 =>
      'Снимайте обява и изчезналата котка влиза в каталога с контакта на собственика си. Наблюдения, кръгове за търсене и предложения за съвпадение помагат да се прибере у дома.';
