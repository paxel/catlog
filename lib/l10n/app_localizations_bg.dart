...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String deleteCatalogBody(String name) {
    return 'Всичко в $name изчезва: котките, снимките, историята. Първо се записва пълен файл там, където отиват автоматичните архиви — импортирането му връща каталога. Напишете показаната дума, за да потвърдите.';
  }
