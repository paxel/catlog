...
class AppLocalizationsBg extends AppLocalizations {
  ...
  String get spotHomeAgenda =>
      'Напомнянията: всичко предстоящо, за всички котки и клаудери.';

  @override
  String get spotAddReminder =>
      'Добави напомняне — план с дата. Показва се в напомнянията, не на страницата, докато не го отбележиш като готово.';

  @override
  String get spotAgendaAdd => 'Нов план: избери поле, дата и стойност.';

  @override
  String get spotAgendaCalendar =>
      'Включи това, за да виждаш всеки срок в календара на телефона си.';

  @override
  String get helpAgenda =>
      'Всичко предстоящо, по дата; закъснялото остава най-отгоре, докато не бъде уредено. Докосни карта, за да отвориш котката или клаудера. Отметката отбелязва план като готов — записва стойността и може да насрочи следващия път. Задръж карта, за да промениш датата или да я премахнеш. Превключвателят за календар отразява всеки срок в календар на телефона ти; менюто ги експортира като календарен файл.';
