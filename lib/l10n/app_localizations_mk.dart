...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get helpClowder =>
      'Сè за ова место: неговите мачки, полиња (адреса, контакт, вид) и историја. Страницата се отвора само за читање; моливот вклучува уредување, каде може да додадеш и ново поле. Долг притисок на поле го уредува веднаш, на мачка ја преместува, крие или отвора.';
  ...
  String get agendaEmpty =>
      'Ништо не доспева. Избери иден датум на поле и ќе се појави тука.';
  ...
  String get calendarMirrorSubtitle =>
      'Секој рок станува целодневен настан во cat(a)log календар на овој уред. Датумите менувај ги во cat(a)log, не во календарот.';
  ...
  String get reminderDialogHint =>
      'Се прикажува во потсетниците додека не го означиш како завршено. Тековната вредност останува каква што е.';
  ...
  String get noWritableCalendar =>
      'Во ниту еден календар на овој уред не може да се запишува. Додај сметка за календар во системските поставки и обиди се повторно.';

  @override
  String get spotHomeAgenda =>
      'Потсетниците: сè што доспева, за сите мачки и клаудери.';

  @override
  String get spotAddReminder =>
      'Додај потсетник — план со датум. Се прикажува во потсетниците, не на страницата, додека не го означиш како завршено.';

  @override
  String get spotAgendaAdd => 'Нов план: избери поле, датум и вредност.';

  @override
  String get spotAgendaCalendar =>
      'Вклучи го ова за да го гледаш секој рок во календарот на телефонот.';

  @override
  String get helpAgenda =>
      'Сè што доспева, по датум; задоцнетото останува најгоре додека не се среди. Допри картичка за да ја отвориш мачката или клаудерот. Штиклата означува план како завршен — ја запишува вредноста и може да го закаже следниот круг. Задржи картичка за да го промениш датумот или да ја отстраниш. Прекинувачот за календар го пресликува секој рок во календар на твојот телефон; менито ги извезува како календарска датотека.';
