...
class AppLocalizationsMk extends AppLocalizations {
  ...
  String get helpCatalogsNeutral =>
      'Секој каталог е свет за себе: свои миленици, домаќинства, полиња, фотографии и партнери за синхронизација. Берлин и Париз никогаш не се мешаат. Допри го името горе на почетниот екран за да смениш, додадеш или преименуваш. Твоето име, јазикот и веќе видените совети се заеднички.';
