...
- A chore's history lets a done day be corrected to another moment or removed; the day then reads missed or open again, and a removed tick can be restored.
